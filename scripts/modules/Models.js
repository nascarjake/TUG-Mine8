(function(){
	...
	app.factory('Section', ['Content', 'msgHan', function(Content, msgHan){
		...
		Section.prototype.deleteContent = function(index){
			$scope.msgHan.fire('AreYouSurePopup.open', {message: "Are you sure you want to delete this piece of content?", cb: function() {
	...
	app.factory('Manifest', ['msgHan', 'ManifestServices', 'Section', 'Content', 'Media', function(msgHan, ManifestServices, Section, Content, Media){
		var defaultMedia1 = new Media('video', "-HrwaxZbsnY")
        ...
        Manifest.prototype.getMediaLink = function(id){
        	try{
                var media = this.Media.filter(function(e){return e.Id == id})[0]
                if(media){
        ...
        Manifest.prototype.validate = function() {
            ...
            if(!this.WebPage.HeaderMedia)
            	this.WebPage.HeaderMedia = [defaultMedia1.Id]
            if(!this.WebPage.DetailMedia)
            	this.WebPage.DetailMedia = [defaultMedia2.Id]
        }
        ...
        Manifest.prototype.deleteSection = function(evt){
        	var self = this;
        	msgHan.fire('AreYouSurePopup.open', {message: "Are you sure you want to delete this section?", cb: function() {
