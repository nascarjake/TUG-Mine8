(function(){
    ...
    app.controller('ModHomepageCtrl', 
        ['$scope', 'msgHan', 
        'Section', 'Manifest', 
        ...
        $scope.contentTypes = [
                                ...
                                {value: 'MediaElement', title: "Media Element"},
                                {value: 'Tabs', title: 'Tab Group'},
        ...
        $scope.alert = function(title, msg, cb){
            msgHan.fire('AlertPopup.open', {title: title, message: msg, cb: cb});
        }
            ...
            setTheme: function() {
                if ($scope.modManifest.WebPage['Theme']) {
                    ...
                    if ($scope.modManifest.WebPage.Theme.Secondary.Background) {
                        $('.secondary, footer').css('background', $scope.modManifest.WebPage.Theme.Secondary.Background + ' ' + $scope.modManifest.WebPage.Theme.Secondary.Color);
                    } else {
                        $('.secondary, footer').css('background-image', "none");
                    }
                    if ($scope.modManifest.WebPage.Theme.Body.Background) {
                        $('body, .bodyClass').css('background', $scope.modManifest.WebPage.Theme.Body.Background + ' ' + $scope.modManifest.WebPage.Theme.Body.Color);
                    } else {
